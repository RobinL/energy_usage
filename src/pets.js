...
function kwh_required_by_dogs_per_day(weight_in_kg) {
    ...
    // How much energy is required to produce one cal of food?
    ...
    // let houles = convert.per("j/kcal") * energy_reqired_to_produce_food_in_kcal
    // let joules = utils.JOULES_PER_KCAL * energy_reqired_to_produce_food_in_kcal
